...
mod fuzz_tests {
    ...
    proptest! {
        ...
        fn fuzz_config_parse_no_panic(s in ".*") {
            let _ = s.parse::<reestream_core::config::Config>();
        }
        ...
        fn fuzz_flv_tag_no_panic(
            ...
            let _ = reestream_server::flv::build_flv_tag(tag_type, timestamp, &data);
        }
        ...
        fn fuzz_ip_cidr_match(
            ...
            let entry = reestream_core::security::IpEntry {
        ...
        fn fuzz_watermark_position_no_panic(
            ...
            use reestream_ffmpeg::processing::WatermarkPosition;
            let positions = [
